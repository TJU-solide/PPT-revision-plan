...
Moreover, through experiments, we have already demonstrated that DCTCP achieves performance comparable to state-of-the-art proactive transport protocols when utilizing spare bandwidth.
